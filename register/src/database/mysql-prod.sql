...
CREATE USER 'register'@'localhost' IDENTIFIED BY 'xxx';
CREATE USER 'register'@'%' IDENTIFIED BY 'xxx';

CREATE USER 'registersu'@'localhost' IDENTIFIED BY 'xxx';
CREATE USER 'registersu'@'%' IDENTIFIED BY 'xxx';
